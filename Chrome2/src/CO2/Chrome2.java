...
public class Chrome2 {
		...
		*/
		...
		System.out.println(sp.size());
							for(int j=0;j<sp.size();j++){
								...
								Thread.sleep(3000);
								List<WebElement> dest=driver.findElements(By.xpath("//div[@id='pnlToSubPlace']/input"));
								...
								for(int y=1;y<=s2;y++){
									...
									Thread.sleep(5000);
									String destination =driver.findElement(By.xpath("//div[@id='pnlToSubPlace']/input["+y+"]")).getAttribute("title");
									driver.findElement(By.xpath("//div[@id='pnlToSubPlace']/input["+y+"]")).click();
	...
	public String[] Data(int rr) throws IOException{
		...
		File f=new File("C:\\Users\\CTBCS\\Desktop\\7.xlsx");
